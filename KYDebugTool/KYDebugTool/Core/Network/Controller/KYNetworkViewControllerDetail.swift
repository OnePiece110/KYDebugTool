//
//  KYNetworkViewControllerDetail.swift
//  KYDebugTool
//
...
final class KYNetworkViewControllerDetail: KYBaseController {
    private var model: KYHttpModel
...
extension KYNetworkViewControllerDetail: UITableViewDelegate, UITableViewDataSource {
    ...
    private func setupTableView() {
        ...
        tableView.register(
            KYNetworkTableViewCellDetail.self,
        ...
        if indexPath.section == .zero {
            ...
            let cell =
                tableView.dequeueReusableCell(
                    ...
                    for: indexPath
                ) as! KYNetworkTableViewCellDetail
...
extension KYNetworkViewControllerDetail: UISearchResultsUpdating {
...
extension KYNetworkViewControllerDetail {
    struct Config {
        let title: String
...
extension [KYNetworkViewControllerDetail.Config] {
    init(model: KYHttpModel) {
        self = [
            .init(
                title: "TOTAL TIME",
...
extension KYNetworkViewControllerDetail {
    ...
    @objc private func shareButtonTapped() {
        ...
        do {
            ...
            KYDebug.print("Error: \(error.localizedDescription)")
        }
    }
