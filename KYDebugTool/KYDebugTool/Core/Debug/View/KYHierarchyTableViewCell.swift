//
//  KYHierarchyTableViewCell.swift
//  KYDebugTool
//
...
protocol KYHierarchyTableViewCellDelegate: AnyObject {
...
final class KYHierarchyTableViewCell: UITableViewCell {
    ...
    let lineView: KYParallelLineView = {
        let lineView = KYParallelLineView()
    ...
    private lazy var subtreeButton: UIButton = { [unowned self] in
        ...
        let disclosureImage = UIImage(named: "DisclosureIndicator", in: Bundle(for: KYHierarchyTableViewCell.self), compatibleWith: nil)
    ...
    weak var delegate: KYHierarchyTableViewCellDelegate?
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        selectedBackgroundView = {
            ...
            backgroundView.backgroundColor = UIColor(white: 0.2, alpha: 1.0)
