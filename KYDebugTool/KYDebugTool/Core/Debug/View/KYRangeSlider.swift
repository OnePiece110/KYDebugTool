...
class KYRangeSliderTrackLayer: CALayer {
    weak var rangeSlider: KYRangeSlider?
...
class KYRangeSliderThumbLayer: CALayer {
...
final class KYRangeSlider: UIControl {
    ...
    fileprivate let trackLayer = KYRangeSliderTrackLayer()
    fileprivate let lowerThumbLayer = KYRangeSliderThumbLayer()
    fileprivate let upperThumbLayer = KYRangeSliderThumbLayer()
