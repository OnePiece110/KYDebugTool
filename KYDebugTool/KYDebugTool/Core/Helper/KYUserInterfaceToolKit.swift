...
final class KYUserInterfaceToolkit {
    // MARK: - Properties

    static let shared = KYUserInterfaceToolkit()

    var gridOverlay = KYGridOverlayView()
    var gridOverlayColorSchemes: [KYGridOverlayColorScheme] = [
...
extension KYUserInterfaceToolkit {
