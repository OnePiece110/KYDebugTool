...
final class KYGridOverlayView: KYTopLevelViewWrapper {
    ...
    var colorScheme: KYGridOverlayColorScheme? = .init(
        primaryColor: .red,
    ...
    func setupUI() {
        guard
            let superview = KYWindowManager.window.rootViewController?.view
        else { return }
